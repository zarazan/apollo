...
import ZarazanApolloZarazanApolloApollo from './zarazan/apollo/zarazan.apollo.apollo'
...
export default { 
  ...
  ZarazanApolloZarazanApolloApollo: load(ZarazanApolloZarazanApolloApollo, 'zarazan.apollo.apollo'),
